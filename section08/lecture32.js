...
console.log('lecture32: ', meanMedianMode([1, 2, 3, 4, 5, 4, 6, 1]));
...
// num modeObj[num]:  5 1
// num modeObj[num]:  6 1
// lecture32:  { mean: 3.25, median: 3.5, mode: [ '1', '4' ] }

console.log('lecture32: ', meanMedianMode([9, 10, 23, 10, 23, 9]));
// modeObj:  { '9': 2, '10': 2, '23': 2 }
// num modeObj[num]:  9 2
// num modeObj[num]:  10 2
// num modeObj[num]:  23 2
// lecture32:  { mean: 14, median: 10, mode: [] } // no mode
